...
### 1. 游戏化萌系「打工怨气槽」（`RageMeter` & `FaceMotion`）

- **全新游戏 HUD 级怒气条（核心卖点）**：
  - 将原先单一的文本药丸升维重构成悬浮于舞台上方的 **游戏化萌系打工怨气 HUD**；
  - **原生 WebGPU (WGSL) 流体着色器**：数学 SDF 胶囊药丸管体中，双层流体波浪在黏稠阻尼下自然翻涌，内置多粒径碳酸/岩浆微气泡徐徐升腾；
  - **交互惯性晃荡与打击感（Hit Juice）**：戳击或晃动时流体左右惯性冲刷，怒气槽受击产生软糖般的果冻挤压形变（`scale(1.08, 0.92)` 弹性阻尼回弹），液面爆出白光冲击闪烁（Hit Flash）；
  - **萌系微表情动态头像（Avatar Face）**：怒气条左侧嵌入动态迷你史莱姆头像，从放空微笑（`^‿^`）、撇嘴抽搐（`>_<`）、闭眼打鼾（`zZ`）到暴怒圆睁，额头浮现高频跳动的微型 💢 怒筋；
- **四档多梯度怒气与满槽爆裂（BURST）**：
  - 🟢 **0%~30% 佛系摸鱼（Chill）**：温柔抹茶草莓淡粉果冻液，慢速微风细浪与慵懒碳酸微光；
  - 🟡 **31%~70% 有点上火（Annoyed）**：气泡加速翻滚的阳光甜橙汽水流体，外框轻度预警；
  - 🔴 **71%~99% 暴怒红温（Rage）**：炽烈深红熔岩电浆，沸腾剧烈，自发光晕开；
  - 💥 **100% MAX 怨气爆表（OVERHEAT BURST）**：炽白电浆核心，怒气槽剧烈颤抖震荡（Bar Jitter & Screen Shake），外圈喷薄金色电火花与火焰微粒，显示闪耀的 `MAX! 怨气爆表!`！
  - 🔵 **摸鱼休眠（Sleepy）**：无交互 15 秒后自动进入夜空幽蓝睡眠流体，伴随安详鼾泡呼吸起伏；
- **自然怨气冷却**：停止打扰后，怨气以平滑阻尼自然消退退温，流体如退潮般温和降至 0%。
